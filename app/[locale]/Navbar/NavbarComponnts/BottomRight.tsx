...
const BottomRight = () => {
  ...
  return (
    ...
    <Link href='/order' className='flex items-center justify-center gap-x-2 hover:cursor-pointer  xl:text-sm duration-700 hover:text-blue-500 xl:hover:text-white xl:border-b border-[#262626] lg:hover:border-[#39FF14] text-gray-600 lg:text-white text-lg '><FaCartArrowDown  />  <span className="hidden xl:block">Order</span>{cartLength>0 && <div className='size-5 text-xs rounded-full flex items-center justify-center bg-green-400 text-white'>{cartLength}</div>}</Link>
