...
const BottomRight = () => {
  return (
    ...
    <Link href='/cart' className='flex items-center justify-center gap-x-2 hover:cursor-pointer'><FaCartArrowDown  /><span>Card</span><div className='size-5 text-xs rounded-full flex items-center justify-center bg-green-400 text-white'>3</div></Link>
</div>
  )
}
