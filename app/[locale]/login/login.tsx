  ...
  return (
    <div className='w-full flex flex-col items-start justify-start space-y-6 py-5 lg:pr-15 border-gray-300  lg:border-r'>
     ...
     <div className='w-full flex flex-col space-y-1'>
      ...
      <input type='text' required   placeholder='Enter your email' className='w-full p-1 placeholder:text-gray-600 focus:outline-none placeholder:sm text-sm text-gray-500 rounded-md border border-gray-200' /> 
     </div>
