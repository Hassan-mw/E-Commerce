   ...
   return (
     <div className='w-full flex flex-col items-start justify-start space-y-6 py-5 '>
      ...
      <div className='w-full flex flex-col space-y-1'>
       ...
       <input type='text' required   placeholder='Enter your name' className='w-full p-1 focus:outline-none placeholder:sm text-sm text-gray-600 placeholder:text-gray-600 rounded-md border border-gray-200' /> 
      </div>
      ...
      <div className='w-full flex flex-col space-y-1'>
       ...
       <input type='text' required   placeholder='Enter your email' className='w-full p-1 focus:outline-none placeholder:sm text-sm text-gray-600 placeholder:text-gray-600 rounded-md border border-gray-200' /> 
      </div>
     ...
     {/*Signup-Button  */}
     <div className='w-full rounded-md Data_Center p-3 bg-[#4172DC] hover:bg-blue-700 hover:cursor-pointer duration-500 text-white'>SIGN UP</div>
