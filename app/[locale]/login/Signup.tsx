   ...
   return (
     <div className='w-full flex flex-col items-start justify-start space-y-6 py-5 '>
      ...
      <div className='w-full flex flex-col space-y-1'>
       <h2 className='text-md font-medium text-[#262626]'>Name</h2>
       <input type='text' required   placeholder='Enter your name' className='w-full p-1 focus:outline-none placeholder:sm text-sm text-gray-500 rounded-md border border-gray-200' /> 
      </div>
