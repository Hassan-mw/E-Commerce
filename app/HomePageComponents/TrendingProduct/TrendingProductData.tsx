...
const TrendingProductData = () => {
  ...
  return (
    <div className='w-full  grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3  gap-10 sm:gap-7 py-9'>
        {
...
<Image height={180} width={180} src={`/${data.image}`} className='object-cover w-full h-full sm:max-h-80  object-top rounded-t-md' alt='product_image' />
