...
const TopLeft = () => {
  return (
    ...
    <div className=' flex flex-col items-start justify-start h-full p-4 space-y-3 w-full bg-pink-500'>
    ...
    <div className='w-full flex items-start justify-start' >  <span style={{fontWeight:200}} className={`  gap-x-3 bg-[#4172DC]  p-2  text-[9px]  rounded-xs text-white flex items-center justify-center`}>READ MORE <FaArrowRight /></span></div>
     ...
     <Image height={500} width={500} className='bg-red-800  w-full max-w-[50%]  sm:hidden   object-center ' src="/a-w.png" alt="blog_main_image" />  
