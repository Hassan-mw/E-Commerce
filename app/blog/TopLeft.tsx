...
const TopLeft = () => {
  return (
    ...
    <div className=' flex flex-col items-start justify-start  p-4 space-y-3 w-full col-span-3 sm:col-span-4'>
     ...
     <div className={`${jost.className} text-[#555555] text-[9px] hidden sm:block`}>In this captivating scene, a stylish woman stands confidently against a pristine backdrop, capturing the essence of summer's allure. Bathed in the gentle sunlight, she emanates an air of effortless chic. Her outfit ....</div>
     <div className={`${jost.className} text-[#555555] text-[9px] sm:hidden`}>In this captivating scene, a stylish woman stands confidently against a pristine backdrop, capturing the essence of summer's allure. Bathed in the gentle ....</div>
