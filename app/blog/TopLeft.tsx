...
const TopLeft = () => {
  return (
    <div className='  w-full grid grid-cols-5 sm:grid-cols-6 col-span-3 sm:bg-orange-200 md:bg-green-400 lg:bg-red-400' >
