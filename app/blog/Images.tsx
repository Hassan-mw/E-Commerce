...
const Images = () => {
  return (
      <div className='w-full flex items-center justify-center'>
       <div> </div><Image height={1500} width={1500} className=' object-contain hidden lg:block ' src="/bg-left.png" alt="blog_main_image" />  
      <Image height={1500} width={1500} className=' object-contain hidden lg:block ' src="/blog_image_lg.png" alt="blog_main_image" />  
